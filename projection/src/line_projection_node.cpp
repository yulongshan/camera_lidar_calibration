...
public:
        ...
        sync = new
                message_filters::Synchronizer
                        <SyncPolicy>(SyncPolicy(10),
                                     *line1_image_sub, *line2_image_sub, *line3_image_sub, *line4_image_sub,
                                     *line1_cloud_sub, *line2_cloud_sub, *line3_cloud_sub, *line4_cloud_sub);
    ...
    void callback(const line_msg::lineConstPtr line1_img_msg,
                  ...
                  const sensor_msgs::PointCloud2Ptr line1_msg,
                  const sensor_msgs::PointCloud2Ptr line2_msg,
                  const sensor_msgs::PointCloud2Ptr line3_msg,
                  const sensor_msgs::PointCloud2Ptr line4_msg) {
